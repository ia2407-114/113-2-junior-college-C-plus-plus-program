...
拉專案下來
```
git clone https://github.com/ia2407-114/113-2-junior-college-C-plus-plus-program.git 學號
```
<br>
...
設定遠端節點
```
git remote add origin https://github.com/ia2407-114/113-2-junior-college-C-plus-plus-program.git
```
<br>
